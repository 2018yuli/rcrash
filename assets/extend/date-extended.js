...
import isExtended from "./is-extended.js";
import arrayExtended from "./array-extended.js";
...
function defineDate(extended, is, array) {
    ...
    return extended.define(is.isDate, date).define(is.isString, stringDate).define(is.isNumber, numberDate);
}

const dateExtended = defineDate(extended, isExtended, arrayExtended);
