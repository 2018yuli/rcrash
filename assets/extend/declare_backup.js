// declare.js - ES Module for Deno Core
...
function createDeclared() {
    ...
    function defineProps(child, proto) {
        const s = proto.setters || {}, g = proto.getters || {};
    ...
    function __declare(child, sup, proto) {
        ...
        const bases = [], staticBases = [];
        const instanceSupers = [], staticSupers = [];
        const meta = {
        ...
        if (proto) {
            ...
            childProto.constructor = functionWrapper(inst.constructor || defaultFunction, "constructor");
    ...
    const Base = declare({
        ...
        static: {
            ...
            extend: function (proto) { return declare(this, proto); },
